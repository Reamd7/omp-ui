...
/**
 * Arrows-merge icon — visualizes multiple branches converging.
 *
 * Migrated from openchamber (no changes — pure SVG).
 * Source: packages/ui/src/components/icons/ArrowsMerge.tsx
 */
