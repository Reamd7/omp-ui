    ...
    <Card className="w-80">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          Card content — use this surface to group related information with a subtle border and
          padded sections.
        </p>
      </CardContent>
    </Card>
...
export const WithAction: Story = {
  render: () => (
    <Card className="w-80">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          Header uses <code className="rounded bg-muted px-1">grid</code> layout so an action lands
          in the top-right column automatically.
        </p>
      </CardContent>
    </Card>
  ),
  ...
  render: () => (
    <div className="flex flex-wrap items-start gap-4">
      ...
      <Card className="w-64 border-destructive/40">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Override <code className="rounded bg-muted px-1">border</code> via class.
          </p>
        </CardContent>
      </Card>
      <Card className="w-64 bg-primary/5">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">Tinted background for emphasis.</p>
        </CardContent>
      </Card>
    </div>
  ),
