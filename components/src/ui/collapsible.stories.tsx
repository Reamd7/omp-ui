...
const sampleContent = (
  <div className="text-sm text-muted-foreground">
    Collapsible content. Click the trigger again to hide this section. The animation uses
    tw-animate-css fade + zoom utilities on the panel.
  </div>
);
      ...
      return (
        ...
        >
          <Collapsible open={a} onOpenChange={setA}>
            <CollapsibleTrigger>
              <span>Section A</span>
              <ChevronDown className={`size-4 transition-transform ${a ? "rotate-180" : ""}`} />
            </CollapsibleTrigger>
            <CollapsibleContent>
          ...
          <Collapsible open={b} onOpenChange={setB}>
            <CollapsibleTrigger>
              <span>Section B</span>
              <ChevronDown className={`size-4 transition-transform ${b ? "rotate-180" : ""}`} />
            </CollapsibleTrigger>
            <CollapsibleContent>
