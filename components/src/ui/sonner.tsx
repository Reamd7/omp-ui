    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "!rounded-[var(--radius-md)] !bg-[var(--primary-base)] !text-[var(--primary-foreground)] hover:!opacity-85 !px-2 !py-1 !text-sm !font-medium transition-opacity",
          cancelButton:
            "!rounded-[var(--radius-md)] !bg-[var(--interactive-hover)] !text-foreground hover:!bg-[var(--interactive-active)] !px-2 !py-1 !text-sm !font-medium transition-colors",
          closeButton:
