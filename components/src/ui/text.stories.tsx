...
export const AllVariants: Story = {
  render: (args) => (
    <div className="flex flex-col items-start gap-3 text-foreground">
      <Text {...args} variant="static">static</Text>
      <Text {...args} variant="generate-effect">generate-effect</Text>
      <Text {...args} variant="glitch">glitch</Text>
      <Text {...args} variant="hover-enter">hover-enter (hover me)</Text>
      <Text {...args} variant="shake">shake</Text>
      <Text {...args} variant="hover-decoration">hover-decoration (hover me)</Text>
    </div>
  ),
}
